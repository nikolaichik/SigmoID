...
def createParser():
    ...
    parser = argparse.ArgumentParser(
             prog='Stockholm to Fasta format converter',
             usage='\n%(prog)s <input_file> ',
             description = '''This script allows to convert a multiple alignment in Stockholm format into fasta format file
    Requires Biopython 1.64 (or newer)''',
             epilog='''(c) Yevgeny Nikolaichik, 2018.'''
            )
