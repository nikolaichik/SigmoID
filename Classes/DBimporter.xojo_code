...
Protected Class DBimporter
	...
	#tag Note, Name = Deprecated!
		...
		Since this class was never complete, we fix compilation issue by replacing MSSQLServerDatabase with ODBCDatabase without any required changes.
	...
	#tag Property, Flags = &h21
		Private query As SQLiteDatabase
	#tag EndProperty
