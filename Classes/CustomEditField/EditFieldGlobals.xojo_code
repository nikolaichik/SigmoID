...
Protected Module EditFieldGlobals
	...
	#tag Method, Flags = &h0
		Function loadMaskedPicture(image as picture) As picture
		  ...
		  dim newpic as Picture = NewPicture(image.Width/2, Image.Height, 32)
	...
	#tag Constant, Name = CEF_VERSION, Type = String, Dynamic = False, Default = \"1.6.3", Scope = Protected
	#tag EndConstant
	...
	#tag Constant, Name = TextStorageType, Type = Double, Dynamic = False, Default = \"0", Scope = Protected
